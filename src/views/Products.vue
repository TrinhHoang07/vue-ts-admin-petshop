...
import { Button, Modal, Table, Typography } from 'ant-design-vue';
...
const handleFilterData = (data: I_Products[], type?: string): _T_FormProducts[] => {
    ...
    watch(data, () => {
      dataSource.value = handleFilterData(data.value)
    })
    ...
    watch([activeHeader, data], () => {
      switch (activeHeader.value) {
            case 'dog':
                dataSource.value = (handleFilterData(data.value, 'dog'));
                break;
            case 'cat':
                dataSource.value = (handleFilterData(data.value, 'cat'));
                break;
            case 'food':
                dataSource.value = (handleFilterData(data.value, 'food'));
                break;
            case 'accessory':
                dataSource.value = (handleFilterData(data.value, 'accessory'));
                break;
            default:
                dataSource.value = (handleFilterData(data.value));
        }
    ...
    <div class="wrapper-pro">
            <div class="header-pro">
                ...
                <div class="actions">
                    ...
                    <ModalAddProduct :open="isModalAdd" :setOpen="setIsModalAdd" />
                </div>
            </div>
            <div class="contents">
                                                  ...
                                                  apiService.products
                                                      ...
                                                      .then((res) => {
                                                          ...
                                                          if (res.message === 'success') {
                                                              ...
                                                              data = data.filter(item => item.id !== record.key)
                                                          }
                                                      })
                    ...
                    >
                      <template #footer>
                        <Button type="primary" @click="description = ''">
                                Ok
                            </Button>
                      </template>
